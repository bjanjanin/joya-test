    ...
    $.fn.onepage_scroll = function(options) {
        ...
        $.fn.moveDown = function() {
            ...
            if (history.replaceState && settings.updateURL == true) {
                var href = window.location.href.substr(0, window.location.href.indexOf('#')) + "#" + window.types[index];
        ...
        $.fn.moveUp = function() {
            ...
            if (history.replaceState && settings.updateURL == true) {
                var href = window.location.href.substr(0, window.location.href.indexOf('#')) + "#" + window.types[index - 2];
                history.pushState({}, document.title, href);
            }
            el.transformPage(settings, pos, next.data("index"));
        }
        ...
        $.fn.moveTo = function(page_index) {
            ...
            if (next.length > 0) {
                ...
                if (history.replaceState && settings.updateURL == true) {
                    var href = window.location.href.substr(0, window.location.href.indexOf('#')) + "#" + window.types[page_index - 1];
                    history.pushState({}, document.title, href);
